...
struct Sales_data
{
friend bool cmpAvgPrice(const Sales_data &lhs, const Sales_data &rhs);
...
//    bool cmpAvgPrice(const Sales_data &rhs) 
//        { return avg_price() < rhs.avg_price(); }
...
bool cmpAvgPrice(const Sales_data &lhs, const Sales_data &rhs);
